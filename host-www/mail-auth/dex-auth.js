(function (global) {
  ...
  /** LDAP connector only — no Google on mail hostname. */
  function startDexLogin() {
  ...
  global.KM0DexAuth = { startDexLogin: startDexLogin, clearOidcBrowserState: clearOidcBrowserState };
})(window);
